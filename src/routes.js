...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/register', component: () => import('@/pages/coaches/CoachRegister.vue'), meta: {requiresAuth: true} },
    { path: '/requests', component: () => import('@/pages/requests/RequestReceive.vue'), meta: {requiresAuth: true} },
